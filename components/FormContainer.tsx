  ...
  return (
    <section className="flex flex-col">
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex flex-col gap-8 relative">
            ...
            <div className="flex-shrink-0 absolute left-0 bottom-0">
              <div className="w-110 h-64 bg-transparent rounded-lg overflow-hidden relative">
                <Image
            ...
            <div className="flex flex-wrap gap-4 justify-center items-center mb-4">
              <div className="relative">
                <span className="bg-red-600 text-white px-2 py-1 font-bold animate-pulse text-5xl">
                  {type === 1
                    ? dict?.action || "Акція"
            ...
            <div className="flex-1 text-center lg:text-right">
              {type === 1 ? (
                <div className="text-5xl text-gray-800 mb-4 font-sans">
      ...
      <div className="bg-blue-900 py-8">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-white text-3xl font-semibold mb-8 text-start">
          ...
          >
            <div className="flex-1 min-w-[175px] max-w-[200px]">
              <input
                type="text"
                name="name"
                value={formData.name}
            ...
            <div className="flex-1 min-w-[175px] max-w-[200px]">
              ...
              >
                <option value="">
                  {dict?.banner?.form?.destinationPlaceholder || "Летимо до"}
                </option>
                <option value="turkey">
                  {dict?.destinations?.turkey || "Туреччина"}
                </option>
                <option value="egypt">
                  {dict?.destinations?.egypt || "Єгипет"}
                </option>
                <option value="greece">
                  {dict?.destinations?.greece || "Греція"}
                </option>
                <option value="spain">
                  {dict?.destinations?.spain || "Іспанія"}
                </option>
                <option value="italy">
                  {dict?.destinations?.italy || "Італія"}
                </option>
                <option value="france">
                  {dict?.destinations?.france || "Франція"}
                </option>
                <option value="other">
                  {dict?.destinations?.other || "Інше"}
                </option>
              </select>
            </div>
